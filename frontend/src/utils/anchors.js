/**
 * Rotation-aware anchor position for a note or shape element.
 * @param {{ x, y, w, h, shape?: string, rotation?: number }} el
...
/**
 * Collect all connectable anchor points from notes and non-line shapes.
 * @param {Array} notes
 * @param {Array} shapes
 * @returns {Array<{ x, y, connId, connType, connSide }>}
 */
...
/**
 * Find the nearest anchor within a given threshold distance.
 * @param {Array} anchors  - from getAllAnchors()
 * @param {number} worldX
 * @param {number} worldY
 * @param {number} threshold  - max distance in world units
 * @returns {object|null}  the best anchor, or null if none within threshold
 */
